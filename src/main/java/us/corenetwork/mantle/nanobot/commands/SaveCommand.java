...
import net.minecraft.server.v1_6_R4.NBTBase;
import net.minecraft.server.v1_6_R4.NBTTagByte;
import net.minecraft.server.v1_6_R4.NBTTagByteArray;
import net.minecraft.server.v1_6_R4.NBTTagCompound;
import net.minecraft.server.v1_6_R4.NBTTagDouble;
import net.minecraft.server.v1_6_R4.NBTTagFloat;
import net.minecraft.server.v1_6_R4.NBTTagInt;
import net.minecraft.server.v1_6_R4.NBTTagIntArray;
import net.minecraft.server.v1_6_R4.NBTTagList;
import net.minecraft.server.v1_6_R4.NBTTagLong;
import net.minecraft.server.v1_6_R4.NBTTagShort;
import net.minecraft.server.v1_6_R4.NBTTagString;
