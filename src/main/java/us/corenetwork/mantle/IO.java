   ...
   public static synchronized void freeConnection() {
    ...
    public static void PrepareDB()
    {
        ...
        try {
            ...
            st.executeUpdate("CREATE TABLE IF NOT EXISTS chestInventory (ID INTEGER, PlayerUUID STRING, Slot INTEGER, ItemID INTEGER, Damage INTEGER, Amount INTEGER, NBT BLOB)");
            st.executeUpdate("CREATE TABLE IF NOT EXISTS horseSpeeds (ID STRING, Speed REAL)");
            st.executeUpdate("CREATE TABLE IF NOT EXISTS hydration (PlayerUUID STRING PRIMARY KEY, Hydration REAL, Saturation REAL, FatigueLevel INTEGER, FatigueLevelStart INTEGER, DeliveredMessages STRING)");
