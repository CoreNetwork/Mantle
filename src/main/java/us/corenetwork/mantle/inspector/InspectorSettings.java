...
public enum InspectorSettings {
	...
	MESSAGE_SESSION_NOT_ACTIVE("Messages.SessionNotActive", "You must first start inspection using /inspector start"),
	...
	MESSAGE_SKIP("Messages.Skip", "Skipped. You won't see this structure until you use /session start again."),
