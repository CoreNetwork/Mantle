...
public class EndermanTeleport {
	public static void teleportPlayer(Player player, Enderman enderman)
	{
		...
		do
		{
			...
			int x = player.getLocation().getBlockX() + MantlePlugin.random.nextInt(diff) + minDistance;
			int z = player.getLocation().getBlockZ() + MantlePlugin.random.nextInt(diff) + minDistance;
