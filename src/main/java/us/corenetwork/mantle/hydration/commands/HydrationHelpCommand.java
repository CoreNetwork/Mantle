...
public class HydrationHelpCommand extends BaseHydrationCommand {
	...
	public void run(CommandSender sender, String[] args) {		
		...
		for (Entry<String, BaseHydrationCommand> e : MantleHydrationCommand.commands.entrySet())
		{
			komandes.add(Settings.getCommandDescription(e.getKey(), "mantle hydration", e.getValue().desc));
		}  		
