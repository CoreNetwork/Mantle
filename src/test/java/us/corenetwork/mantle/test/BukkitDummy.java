package us.corenetwork.mantle.test;
...
/**
 * Collection of Dummy Bukkit classes that allow Unit testing without actually starting server
 */
public class BukkitDummy
{
    ...
    public static void injectNewServer()
    {
